...
import dummyProducts from '../data/dummyNewArrivalProducts';
 ...
 return (
  <div className="max-w-[1100px] mx-auto px-4 py-10">
   ...
   <div className="flex items-center justify-between">
          <button className="flex items-center gap-2 bg-blue-50 text-blue-600 px-4 py-2 rounded-full hover:bg-blue-600 hover:text-white transition">
